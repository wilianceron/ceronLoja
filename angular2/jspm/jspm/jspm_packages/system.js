...
!function () {
    function e() {
        !function (e) {
            ...
            function m(e) {
                var t = {};
                if ("object" == typeof e || "function" == typeof e)if (X) {
                    var n;
                    for (var r in e)(n = Object.getOwnPropertyDescriptor(e, r)) && F(t, r, n)
                } else {
            ...
            function y() {
                if (K[this.baseURL])return K[this.baseURL];
            ...
            function O(e, t, n) {
                return this["import"](e.module, t).then(function (t) {
                    if (e.prop ? t = v(e.prop, t) : "object" == typeof t && t + "" == "Module" && (t = t["default"]), n && "boolean" != typeof t)throw new TypeError("Condition " + M(e) + " did not resolve to a boolean.");
                    return e.negate ? !t : t
                })
            }
            ...
            var I = "undefined" == typeof window && "undefined" != typeof self && "undefined" != typeof importScripts, L = "undefined" != typeof window && "undefined" != typeof document, A = "undefined" != typeof process && "undefined" != typeof process.platform && !!process.platform.match(/^win/);
            e.console || (e.console = {
                assert: function () {
                }
            });
            ...
            } else if ("undefined" != typeof process && process.cwd)J = "file://" + (A ? "/" : "") + process.cwd() + "/", A && (J = J.replace(/\\/g, "/")); else {
            ...
            F(r.prototype, "toString", {
                ...
                function v(e, t) {
                    ...
                    for (var a = 0, o = t.linkSets.length; o > a; a++)r = D.call(t.linkSets[a].loads, t), -1 != r && t.linkSets[a].loads.splice(r, 1);
            ...
            var N;
            if ("undefined" != typeof XMLHttpRequest)N = function (e, t, n, r) {
                function a() {
                    n(i.responseText)
                }
            ...
            !function () {
                function n(e) {
                    ...
                    if (r) {
                        if ("object" != typeof r)throw new TypeError("load.metadata.sourceMap must be set to an object.");
                ...
                function o(e) {
                    ...
                    if (window.onerror = function (n) {
                        ...
                        }, r(this, e), e.metadata.integrity && o.setAttribute("integrity", e.metadata.integrity), e.metadata.nonce && o.setAttribute("nonce", e.metadata.nonce), p.appendChild(o), p.removeChild(o), a(), window.onerror = s, i)throw i
                }

                var i, s = "undefined" != typeof btoa, l = /^\#\!.*/;
                ...
                var u, c = 0;
                G = function (e) {
                    if ((e.metadata.integrity || e.metadata.nonce) && f)return o.call(this, e);
                    try {
            ...
            l.prototype.config = function (e) {
                ...
                function m(e, t, n) {
                    ...
                    return (r.meta[n] = r.meta[n] || {}).format = "json", r.load(n).then(function () {
                        ...
                        for (var o in a)-1 == D.call(W, o) && delete a[o];
                ...
                d("pushRegister_", function (e) {
                    return function (n) {
                        return e.call(this, n) ? !1 : (i ? this.reduceRegister_(i, n) : s ? this.reduceRegister_(t(), n) : u ? c.push(n) : this.reduceRegister_(null, n),
                            !0)
                    }
                }), d("fetch", function (t) {
                    return function (i) {
                        ...
                        for (var a = 0, o = e.normalizedDeps.length; o > a; a++) {
                            ...
                            if (s && !s.evaluated) {
                                ...
                                if (null === s.groupIndex || s.groupIndex < l) {
                                    if (null !== s.groupIndex && (r[s.groupIndex].splice(D.call(r[s.groupIndex], s), 1), 0 == r[s.groupIndex].length))throw new Error("Mixed dependency cycle detected");
                                    s.groupIndex = l
                                }
                                t(s, n, r)
                            }
                ...
                function u(t, n) {
                    if (!t.module) {
                        ...
                        var f = t.execute.call(e, function (e) {
                            ...
                            if (-1 != D.call(t.normalizedDeps, o))return s(o, n);
                ...
                l.prototype.register = function (e, t, n) {
                    ...
                    return function (t) {
                        ...
                        if (a.defined[t.name])r = a.defined[t.name], r.declarative || (r.deps = r.deps.concat(t.metadata.deps)); else if (t.metadata.entry)r = t.metadata.entry, r.deps = r.deps.concat(t.metadata.deps); else if (!(a.builder && t.metadata.bundle || "register" != t.metadata.format && "esm" != t.metadata.format && "es6" != t.metadata.format)) {
                            if ("undefined" != typeof G && G.call(a, t), !t.metadata.entry && !t.metadata.bundle)throw new Error(t.name + " detected as " + t.metadata.format + " but didn't execute.");
                            r = t.metadata.entry, r && t.metadata.deps && (r.deps = r.deps.concat(t.metadata.deps))
                        }
                        r || (r = k(), r.deps = t.metadata.deps, r.execute = function () {
                        }), a.defined[t.name] = r;
                        var o = f(r.deps);
            ...
            d("fetch", function (e) {
                ...
                function t(e) {
                    function t(e, t) {
                        for (var n = 0; n < e.length; n++)if (e[n][0] < t.index && e[n][1] > t.index)return !0;
                        return !1
                    }
                ...
                var n = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF.])(exports\s*(\[['"]|\.)|module(\.exports|\['exports'\]|\["exports"\])\s*(\[['"]|[=,\.]))/, r = /(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF."'])require\s*\(\s*("[^"\\]*(?:\\.[^"\\]*)*"|'[^'\\]*(?:\\.[^'\\]*)*')\s*\)/g, a = /(^|[^\\])(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, o = /("[^"\\\n\r]*(\\.[^"\\\n\r]*)*"|'[^'\\\n\r]*(\\.[^'\\\n\r]*)*')/g;
                d("instantiate", function (a) {
                    return function (o) {
                        ...
                        if (o.metadata.format || (n.lastIndex = 0, r.lastIndex = 0, (r.exec(o.source) || n.exec(o.source)) && (o.metadata.format = "cjs")), "cjs" == o.metadata.format) {
                            var s = o.metadata.deps, l = o.metadata.cjsRequireDetection === !1 ? [] : t(o.source);
                            ...
                            o.metadata.entry = d, d.deps = l, d.executingRequire = !0, d.execute = function (t, n, r) {
                                ...
                                if (a.resolve = function (e) {
                                    ...
                                    }, !o.metadata.cjsDeferDepsExecute)for (var l = 0; l < s.length; l++)a(s[l]);
                                var u = i.get("@@cjs-helpers").getPathVars(r.id), d = {
                                    exports: n,
                ...
                d("instantiate", function (n) {
                    return function (r) {
                        var a = this;
                        if ("amd" == r.metadata.format || !r.metadata.format && r.source.match(t))if (r.metadata.format = "amd", a.builder || a.execute === !1)r.metadata.execute = function () {
